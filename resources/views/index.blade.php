...
{{--                        <img src="{{ asset('images/university-partner.jpg') }}" alt="">--}}
                    ...
                    <div class="slide-block d-flex justify-content-center">
                        <section class="hero-block">
                            ...
                            <div class="hero-content">
                                ...
                                <p>We cultivate children with compassion, dedicating time to cherish traditions while preparing them
            ...
            <div class="hero-3">
                <div class="video-container">
                    ...
                    <div class="overlay-content">
                        <div class="hero-content">
                            <h1>Quality. Discipline. Services</h1>
                            <p>We cultivate children with compassion, dedicating time to cherish traditions while preparing them to
        ...
        <section id="testimonial" class="testimonial section pt-5">
            <div class="container" data-aos="fade-up" data-aos-delay="100">
